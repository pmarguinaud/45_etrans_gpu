...
SUBROUTINE EGATH_SPEC_CONTROL(PSPECG,KFGATHG,KTO,KVSET,PSPEC,LDIM1_IS_FLD,&
 & KMSMAX,KSPEC2,KSPEC2_G,KPOSSP,KDIM0G,KCPL2M,LDZA0IP)

!**** *EGATH_SPEC_CONTROL* - Gather global spectral array from processors
...
!     LDZA0IP     - Set to zero unused spectral coefficients
      ...
      DO JA=1,NPRTRW
        ...
        IF( ILEN > 0 )THEN
          ...
          CALL MPL_RECV(ZRECV(ISTA:ISTP,IFLDR),KSOURCE=NPRCIDS(IRCV),KTAG=ITAG,&
           ...
           &CDSTRING='EGATH_SPEC_CONTROL')
          IF( ILENR /= ILEN )THEN
            WRITE(0,'("EGATH_SPEC_CONTROL: JFLD=",I4," JA=",I4," ILEN=",I10," ILENR=",I10)')&
            &JFLD,JA,ILEN,ILENR
            CALL ABORT_TRANS('EGATH_SPEC_CONTROL:INVALID RECEIVE MESSAGE LENGTH')
          ENDIF
        ENDIF
      ENDDO
    ENDIF
...
!$OMP END PARALLEL DO
  ...
  CALL GSTATS(785,0)
  CALL MPL_BARRIER(CDSTRING='EGATH_SPEC_CONTROL:')
  CALL GSTATS(785,1)
ENDIF
