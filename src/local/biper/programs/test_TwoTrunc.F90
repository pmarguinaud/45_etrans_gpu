...
!    (analitical temperature filed in this test). First grid is smaller and has smaller
...
DEALLOCATE(GGPBI1,GGPBIR1,SPECTEMP1)
!3.2. Computations for grid 2
!----------------------------

WRITE(*,*) ' '
WRITE(*,*) '**********************************************'
WRITE(*,*) '*         DATA ON BIGGER GRID                *'
WRITE(*,*) '**********************************************'
WRITE(*,*) ' '
...
WRITE(UNIT=*,FMT='(A,I9)') 'NUMBER OF POINTS IN CALCULATION 2:',COUNT
