...
USE TPM_GEN         ,ONLY : NERR, NOUT, LMPOFF, LSYNC_TRANS, NTRANS_SYNC_LEVEL, MSETUP0, &
     &                      NMAX_RESOL, NPRINTLEV, NPROMATR, LALLOPERM, LALLOPERM2
...
LOGICAL            ,OPTIONAL,INTENT(IN)  :: LDALLOPERM2
...
IF (PRESENT (LDMPOFF)) LMPOFF = LDMPOFF
...
IF(PRESENT(LDALLOPERM2)) THEN
  LALLOPERM2=LDALLOPERM2
ENDIF
